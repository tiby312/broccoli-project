...
impl DemoIter {
    ...
    pub fn next(&mut self, area: Vec2<u32>, ctx: &shogo::simple2d::CtxWrap) -> Demo {
        ...
        let k: Demo = match curr {
            0 => Demo::new(intersect_with::make_demo(area, ctx)),
            1 => Demo::new(multirect::make_demo(area, ctx)),
            2 => Demo::new(liquid::make_demo(area, ctx)),
            3 => Demo::new(raycast::make_demo(area, ctx)),
