...
impl DemoIter {
    ...
    pub fn next(&mut self, area: Vec2<u32>, ctx: &shogo::simple2d::CtxWrap) -> Demo {
        ...
        let k: Demo = match curr {
            0 => Demo::new(rect::make_demo(area, ctx)),
            1 => Demo::new(intersect_with::make_demo(area, ctx)),
            2 => Demo::new(nbody::make_demo(area, ctx)),
            3 => Demo::new(liquid::make_demo(area, ctx)),
            4 => Demo::new(raycast::make_demo(area, ctx)),
            5 => Demo::new(knearest::make_demo(area, ctx)),
            6 => Demo::new(original_order::make_demo(area, ctx)),
            7 => Demo::new(raycast_debug::make_demo(area, ctx)),
            _ => unreachable!(),
        };
        self.0 += 1;
