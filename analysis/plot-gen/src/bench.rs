...
pub fn bench(emp: &mut impl GraphEmplace) {
    ...
    emp.write_graph_simple("best-height", |w| {
    ...
    for grow in [2.0] {
        ...
        emp.write_graph_group("colfind", &format!("n_{}", grow), |w| {
    ...
    for n in [60_000] {
        ...
        emp.write_graph_group("colfind", &format!("grow_{}", n), |w| {
    ...
    emp.write_graph_group("par", "par-speedup", |w| {
    ...
    emp.write_graph_group("par", "optimal-seq-fallback-rebal", |w| {
    ...
    emp.write_graph_group("par", "optimal-seq-fallback-query", |w| {
        let l1 = scatter("", res.iter().map(|&(i, x)| (i as i128, x)));
    ...
    emp.write_graph_simple("float-int", |w| {
    ...
    emp.write_graph_group("rebal_vs_query", "rebal_vs_query", |w| {
