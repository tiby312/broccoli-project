...
where
    K: Queries<'a, A = Self::A, Num = Self::Num, T = Self::T>,
{
    type Num: Num;
    ...
    fn assert_for_all_not_in_rect_mut(&mut self, rect: &axgeom::Rect<Self::Num>) {
    ...
    fn assert_for_all_intersect_rect_mut(&mut self, rect: &axgeom::Rect<Self::Num>) {
        let mut res_dino = Vec::new();
    ...
    fn assert_for_all_in_rect_mut(&mut self, rect: &axgeom::Rect<Self::Num>) {
        let mut res_dino = Vec::new();
